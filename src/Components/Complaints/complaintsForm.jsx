...
const ComplaintsForm = () => {
    return (
      <div className="w-full h-[518px] rounded-[10px] p-10 flex flex-col items-center">
        ...
        <div className="flex justify-evenly w-[70%] mt-[2em]">
          <div className="w-[18%] flex justify-between items-center border-[1px] border-[#FF0500] rounded-[10px] py-[5px] px-[10px]">
            <img src={lawIcon} />
            <p className="font-medium text-[20px] font-bengali">Ley Karin</p>
          </div>
          <div className="w-[33%] flex justify-between items-center border-[1px] border-[#FF0500] rounded-[10px] py-[5px] px-[10px]">
            <img src={site} />
            <p className="font-medium text-[20px] font-bengali">Sitio gobierno Ley Karin</p>
          </div>
          <div className="w-[25%] flex justify-between items-center border-[1px] border-[#FF0500] rounded-[10px] py-[5px] px-[10px]">
            <img src={lawIcon} />
