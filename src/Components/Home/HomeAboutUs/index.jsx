...
const HomeAboutUs = () => {
  return (
    <div className="text-[#181818] bg-[#EBEBEB] font-[roboto] py-12 px-10">
      <div className="flex justify-center font-bebas text-[64px]">
        sobre nosotros
      </div>
      <InfoBox width="w-full" height="h-[821]">
        <div className="flex items-start text-[20px] justify-evenly h-1/2 pt-10 px-8 pb-8">
          <img
            alt="us"
          ...
          <div className="w-[40%] text-justify font-bengali flex justify-center">
            <div>
              <div className="font-bengali font-medium text-[18px] leading-[100%] tracking-[4%] text-justify text-gray-800">
                <p className="mb-5 leading-[1.5]">Fundada en el año 1999, Datum Ingeniería, cuenta con una gran trayectoria y experiencia, participando y desarrollando proyectos en diversas áreas de la Ingeniería.</p>
                <p className="leading-[1.5]">Nuestra empresa se enorgullece de contar con un sólido historial respaldado por números que hablan por sí mismos. Con una amplia cartera de proyectos exitosos en nuestro haber, hemos demostrado nuestra experiencia y capacidad una y otra vez.</p>
              </div>
            </div>
          </div>
        </div>
